...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        # New temporal prefilter and 4D KNN scale (defaults preserve old behavior)
        self.prefilter_temporal = False
        self.temporal_mask_thresh = 0.05
        self.knn_t_scale = 10.0
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_ENAC = 0.1
        self.use_depth = True
        self.depth_weight = 0.01
        # New regularizers (defaults preserve old behavior)
        self.lambda_knn4d = 0.0
        self.knn_k = 8
        self.lambda_opa_entropy = 0.0
        # VGGT prior parameters
        self.use_scale_depth = True
        self.lambda_si = 0.0
        self.lambda_depth_grad = 0.0
        self.prior_depth_weight = 0.0
        # Progressive integration parameters
        self.prior_warmup_steps = 1000
        self.prior_max_weight = 0.01
