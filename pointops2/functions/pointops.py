...
# JIT编译pointops2_cuda模块
try:
    import pointops2_cuda as pointops_cuda
except ImportError:
    print("⚠️  pointops2_cuda 模块未找到，尝试JIT编译...")
    import os
    import torch
    ...
    if sources:
        try:
            ...
            print(f"❌ JIT编译失败: {e}")
            raise ImportError("无法编译pointops2_cuda模块")
    else:
        raise ImportError("未找到pointops2源文件")
