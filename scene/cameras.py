...
class Camera:
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 cx=-1, cy=-1, fl_x=-1, fl_y=-1, depth=None, resolution=None, image_path=None, meta_only=False, mask_path=None,
                 mask=None,
                 prior_depth=None, prior_conf=None
                 ):
        ...
        self.depth = depth
        # Optional external priors (e.g., StreamVGGT)
